[cybersecurityprj2-eb48] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecurityprj2-eb48] container is NOT running**.

.. tip::
   You must have your [cybersecurityprj2-eb48] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d -p 39827:39827 -p 41287:41287 -p 34245:34245 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecurityprj2-eb48 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecurityprj2-eb48 \-\-env GITUSERNAME=joshi-shubham  \-\-env GITREPOURL=https://github.com/joshi-shubham/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=39827  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=41287  \-\-env SOLUTIONVIPERVIZPORT=34245 \-\-env DOCKERUSERNAME='shubjoshi' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=38835 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='shubjoshi2056' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  shubjoshi/cybersecurityprj2-eb48-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - shubjoshi/cybersecurityprj2-eb48-amd64
...
[cybersecurityprj2-eb48] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/joshi-shubham/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecurityprj2-eb48
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecurityprj2-eb48
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=39827, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35305, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41139, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37899, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46227, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38857, HPDEHOST=127.0.1.1, HPDEPORT=44299, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46461

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2062-cybersecurityprj2-eb48,solution_preprocessing_ai_mqtt_dag-cybersecurityprj2-eb48, python-preprocess-7647-cybersecurityprj2-eb48,solution_preprocessing_ai_mqtt_dag-cybersecurityprj2-eb48, python-ai-3087-cybersecurityprj2-eb48,solution_preprocessing_ai_mqtt_dag-cybersecurityprj2-eb48, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
